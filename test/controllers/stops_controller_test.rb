...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { description: @stop.description, name: @stop.name, stop_image: @stop.stop_image }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { description: @stop.description, name: @stop.name, stop_image: @stop.stop_image }
    assert_redirected_to stop_path(assigns(:stop))
  end
